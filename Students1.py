...
windows.title('Student Registration Project')
...
def upload():
    ...
    filename = filedialog.askopenfilename(initialdir=os.getcwd(), title='Image File',
    ...
    image_resize = img.resize((150, 150))#Return a resized copy of the image
    selected_Image = ImageTk.PhotoImage(image_resize)#Is to make the image compatible with tkinter
    ...
    img.save("C:\\Users\\spoll\\StudentRegistrationProject/" + str(selected_Image) + ".jpg")
...
def register():
    ...
    if id_entryname.get() == '' or firstnameEntry.get() == '' or lastnameEntry.get() == '' or dobEntry.get() == '' \
        ...
        studentDetailsText.insert(END, '**********************Student Information*************' + '\n')
        ...
        studentDetailsText.insert(END, "                                                        " + "\n")
        studentDetailsText.insert(END, "Major: \t\t\t\t" + class_1Entry.get() + "\n")
        studentDetailsText.insert(END, "                                                        " + "\n")
        ...
        studentDetailsText.insert(END, "                                                        " + "\n")
        studentDetailsText.insert(END, "State: \t\t\t\t" + variable1.get() + "\n")
        studentDetailsText.insert(END, "                                                        " + "\n")
    ...
    # database connection
    connect = sqlite3.connect("Student_Registration_Project.db",
                              detect_types=sqlite3.PARSE_DECLTYPES | sqlite3.PARSE_COLNAMES)
    cursor = connect.cursor()

    connect.execute("CREATE TABLE IF NOT EXISTS Student_Registration_Project_Table(Student_Id TEXT NOT NULL, "
                    "First_Name TEXT NOT NULL, Last_Name TEXT NOT NULL, Date_Of_Birth TEXT NOT NULL, "
                    "Religion TEXT NOT NULL, Major TEXT NOT NULL, Father_Name TEXT NOT NULL, "
                    "Mother_Name TEXT NOT NULL, Home_Address TEXT NOT NULL, Gender TEXT NOT NULL, "
                    "State TEXT NOT NULL, Phone_Number TEXT NOT NULL, Name_Of_Next_Of_Kin TEXT NOT NULL, "
                    "Phone_Number_of_Next_Of_Kin TEXT NOT NULL, Time_Stamp TIMESTAMP)")
    cursor.execute("SELECT * FROM Student_Registration_Project_Table")
    ...
    selection = ("SELECT * FROM Student_Registration_Project_Table WHERE Student_Id = ?")
    ...
    if cursor.fetchone():
        ...
        insert = str("INSERT INTO Student_Registration_Project_Table(Student_Id,First_Name,Last_Name,"
...
prflname = Label(windows, text="Southern New Hampshire", font=('Times New Roman', 18, 'bold'), bg='cadet blue')
prflname.place(x=470, y=0)

prflname2 = Label(windows, text="Registration", font=('Times New Roman', 18, 'bold'), bg='cadet blue')
prflname2.place(x=530, y=40)

# Student frames

data_frame1 = LabelFrame(windows, bd=7, bg='cadet blue', font=('Times New Roman', 13, 'bold'), width=450,
                         height=670, relief=GROOVE)
data_frame1.place(x=2, y=20)

nok_frame = LabelFrame(data_frame1, bd=7, text='Next of Kin', font=('Times New Roman', 10, 'bold'),
                       bg='cadet blue', width=430, height=80)
nok_frame.place(x=2, y=570)

studentDetails_frame = LabelFrame(windows, bd=7, bg='cadet blue', text='Student information',
                                  font=('Times New Roman', 13, 'bold'),
                                  width=450, height=670, relief=GROOVE)
studentDetails_frame.place(x=740, y=20)

studentDetailsText = Text(studentDetails_frame, height=28, width=63, bd=5, bg='white', font=('Times New Roman', 11, 'bold'))
...
# image frame
image_frame = Frame(windows, bd=3, bg='black', width=160, height=160, relief=GROOVE)
image_frame.place(x=500, y=100)
...
student_Id = Label(data_frame1, text='Student ID:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
student_Id.place(x=2, y=10)

id_entryname = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
id_entryname.place(x=200, y=11)

firstname = Label(data_frame1, text='First Name:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
firstname.place(x=2, y=60)

firstnameEntry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
firstnameEntry.place(x=200, y=61)

lastname = Label(data_frame1, text='Last Name:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
lastname.place(x=2, y=110)

lastnameEntry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
lastnameEntry.place(x=200, y=111)

dob = Label(data_frame1, text='DOB:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
dob.place(x=2, y=160)

dobEntry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
dobEntry.place(x=200, y=161)

religion = Label(data_frame1, text='Religion:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
religion.place(x=2, y=210)

religionEntry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
religionEntry.place(x=200, y=211)

class_1 = Label(data_frame1, text='Major:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
class_1.place(x=2, y=260)

class_1Entry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
class_1Entry.place(x=200, y=261)

fatherName = Label(data_frame1, text='Father\'s Name:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
fatherName.place(x=2, y=310)

fatherNameEntry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
fatherNameEntry.place(x=200, y=311)

motherName = Label(data_frame1, text='Mother\'s Name:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
motherName.place(x=2, y=360)

motherNameEntry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
motherNameEntry.place(x=200, y=361)

homeaddress = Label(data_frame1, text='Home Address:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
homeaddress.place(x=2, y=410)

homeaddressEntry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
homeaddressEntry.place(x=200, y=411)

gender.set(0)
genderLabel = Label(data_frame1, text='Gender:', fg='black', bg='cadet blue', font=('Times New Roman', 13, 'bold'))
genderLabel.place(x=2, y=450)

genderRadio1 = Radiobutton(data_frame1, bg='cadet blue', text='Male', variable=gender,
                           value='Male', font=('Times New Roman', 13, 'bold'))
genderRadio1.place(x=200, y=450)

genderRadio2 = Radiobutton(data_frame1, bg='cadet blue', text='Female', variable=gender,
                           value='Female', font=('Times New Roman', 13, 'bold'))
genderRadio2.place(x=290, y=450)

# state selection
stateLabel = Label(data_frame1, text='State:', fg='black', bg='cadet blue', font=('Times New Roman', 13, 'bold'))
stateLabel.place(x=2, y=490)

states = ['Texas', 'California', 'Alabama', 'Georgia', 'Virgina', 'West Virgina', 'Arizona', 'New Mexico', 'Florida',
             'Nevada', 'Washington', 'Colorado', 'Arkansas', 'Mississippi', 'Main', 'North Dakota','Tennessee',
             'South Dakota', 'New York', 'Maryland']

variable1.set('Select State')

stateLabelDropdown = OptionMenu(data_frame1, variable1, *states)
stateLabelDropdown.place(x=200, y=490)

stateLabelDropdown.config(width=15, font=('Times New Roman', 13, 'bold'), fg='black')

phone_no = Label(data_frame1, text='Phone No:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
phone_no.place(x=2, y=530)

phone_noEntry = Entry(data_frame1, width=30, borderwidth=3, font=('Times New Roman', 10))
phone_noEntry.place(x=200, y=531)

# Next of kin
nok = Label(nok_frame, text='Next of Kin:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
nok.place(x=2, y=2)

nokEntry = Entry(nok_frame, width=30, borderwidth=3, font=('Times New Roman', 10))
nokEntry.place(x=195, y=2)

phone_nok = Label(nok_frame, text='Phone No:', font=('Times New Roman', 13, 'bold'), bg='cadet blue', fg='black')
phone_nok.place(x=2, y=31)

phone_nokEntry = Entry(nok_frame, width=30, borderwidth=3, font=('Times New Roman', 10))
...
crnt_date=Label(windows, text=f"{date:%A,%B %d, %Y}", width=22, bg='cadet blue', fg='black',
                font=('#57a1f8', 13, 'bold'))
crnt_date.place(x=475, y=600)
